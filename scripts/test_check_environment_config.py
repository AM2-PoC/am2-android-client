...
class EnvironmentConfigTest(unittest.TestCase):
    ...
    def test_ci_is_billing_aware_and_publishes_bounded_candidates(self):
        ...
        self.assertIn("assembleStagingLegacyCompatDebug", text)
        self.assertIn("assembleStagingSystemTrustDebug", text)
        self.assertIn("am2-client-staging-legacy-debug.apk", text)
        self.assertIn("am2-client-staging-modern-debug.apk", text)
        self.assertIn("variant_legacy=StagingLegacyCompatDebug", text)
        self.assertIn("variant_modern=StagingSystemTrustDebug", text)
